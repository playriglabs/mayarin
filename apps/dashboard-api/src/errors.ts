 ...
 * becomes a 500 with no internal detail leaked to the caller. Mirrors the payment
 * API's single-mapper convention so both surfaces map the taxonomy the same way.
 */
