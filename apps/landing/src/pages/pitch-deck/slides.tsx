...
export const SLIDES: readonly Slide[] = [
  ...
  },
  {
    ...
    notes: [
      "[DEMO MOMENT — HAND OVER TO CITRA] Rizky introduces the IDR 36,000 example in one sentence; Citra follows docs/hackathon-demo-runbook.md and switches to the prepared checkout.",
