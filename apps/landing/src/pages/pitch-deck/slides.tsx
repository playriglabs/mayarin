...
export const SLIDES: readonly Slide[] = [
  ...
  },
  {
    ...
    headline: "The customer holds ETH. The price is in IDR. The merchant only wants USDC.",
    bullets: [
  ...
  },
  {
    ...
    headline: "IDR 36,000 priced. Testnet ETH paid. USDC settled. Chain and ledger agree.",
    bullets: [
    ...
    notes: [
      "[DEMO MOMENT — START LIVE DEMO] Switch from slide 4 to the prepared IDR 36,000 checkout. Follow docs/hackathon-demo-runbook.md.",
      ...
      "Real Base Sepolia payment, 2026-08-19, intent pi_01M0D8X65WSYV0T5FQRQVXV5M7. Payer sent 0.012953540 testnet ETH. Settlement output 2.019586 testnet USDC, fee 0.012118 USDC, merchant net 2.007468 USDC.",
      "The Base Sepolia pool is execution proof, not a mainnet price market. Do not feature the ETH amount.",
      "IDR 36,000 is about S$3 at roughly 12,000 IDR per SGD (August 2026). Base Sepolia is Base's public testnet.",
  ...
  {
    id: "6",
    label: "06 — Merchant-ready product",
    title: "Merchant-ready product",
    ...
    bullets: [
      ...
      "**Merchant.** Catalog, orders, payment timeline, settlement, wallet, analytics, and audit views over real endpoints.",
      "**Developer.** REST API, TypeScript SDK, WooCommerce, signed webhooks, and delivery inspection.",
    ...
    notes: [
      "docs/roadmap.md. IDR and MYR pricing are proven in the catalog; SGD exists in the core asset registry.",
      "Do not imply a live SGD catalog payment until one exists.",
      "Three contracts are deployed and verified on Base Sepolia; keep their addresses in backup C rather than asking the room to read hex.",
      "Passkey browser ceremony, general gas abstraction, and mainnet hardening remain next. Multi-chain expansion belongs in Q&A.",
    ],
    seconds: 60,
  },
  {
